...
СОХРАНЕНИЯ
  ...
  Звёзды, заработанные до установки плагина, засчитываются: четыре достижения
  "три звезды на каждой сцене блока из пяти" читают таблицу рейтингов самой
  игры - ту же, по которой она открывает бонусные сцены. Остальные условия
  плагин считает сам, то есть выполнять их нужно уже с ним.
